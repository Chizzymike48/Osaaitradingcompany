      ...
      <div className="motion-reveal mx-auto max-w-7xl">
        ...
        <div className="mt-10 grid border-t border-[#ddd7cc] md:mt-16 md:grid-cols-2">
          {standards.map(([number, title, description]) => (
            <div key={number} className="motion-standard grid grid-cols-[2.75rem_1fr] gap-3 border-b border-[#ddd7cc] py-7 pr-2 md:grid-cols-[3.25rem_1fr] md:gap-4 md:py-10 md:pr-12">
