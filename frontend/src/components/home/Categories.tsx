...
export default function Categories() {
  return (
    <section className="relative overflow-hidden bg-[#171715] py-20 text-white md:py-32">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative mt-14 grid grid-cols-1 gap-px bg-white/15 md:grid-cols-2 lg:grid-cols-5">
          {CATEGORIES.map((category) => (
            <Link
              key={category.id}
              href={`/products?category=${category.id}`}
              className="group relative min-h-[26rem] overflow-hidden rounded-2xl bg-[#24231f] p-6"
            >
